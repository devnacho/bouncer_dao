...
contract Kit is KitBase {
  ...
  function newInstance() {
    ...
    bytes32 appId = apmNamehash("bouncer");
    bytes32 votingAppId = apmNamehash("voting");
    bytes32 tokenManagerAppId = apmNamehash("token-manager");

    Bouncer app = Bouncer(dao.newAppInstance(appId, latestVersionAppBase(appId)));
    ...
    acl.createPermission(ANY_ENTITY, app, app.ALLOW_ROLE(), voting);
    acl.createPermission(ANY_ENTITY, app, app.REVOKE_ROLE(), voting);
